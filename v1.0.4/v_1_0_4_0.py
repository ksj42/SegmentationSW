...
### setupUi에서 메뉴바 수정 방법
# def setupUi(self):
#     # Set up other UI elements as before
#     # ...
...
#     self.actionMinimize = QtWidgets.QAction(QIcon('path/to/minimize_icon.png'), 'Minimize', self)
#     self.actionMaximize = QtWidgets.QAction(QIcon('path/to/maximize_icon.png'), 'Maximize', self)
#     self.actionClose = QtWidgets.QAction(QIcon('path/to/close_icon.png'), 'Close', self)

#     self.menubar.addAction(self.actionMinimize)
#     self.menubar.addAction(self.actionMaximize)
