...
class CustomMenuBar(QtWidgets.QMenuBar):
    ...
    def mousePressEvent(self, event):
        ...
        super(CustomMenuBar, self).mousePressEvent(event)  # 기본 메뉴 동작도 처리
    ...
    def mouseMoveEvent(self, event):
        ...
        super(CustomMenuBar, self).mouseMoveEvent(event)  # 기본 메뉴 동작도 처리
    ...
    def mouseReleaseEvent(self, event):
        ...
        super(CustomMenuBar, self).mouseReleaseEvent(event)  # 기본 메뉴 동작도 처리
